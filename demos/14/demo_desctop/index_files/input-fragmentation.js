$(document).ready(function () {
    ...
    function manualInput(el) {
        ...
        if (el.siblings(".fragmentation-slider").length > 0) {
            el.siblings(".fragmentation-slider").slider('setValue', amount); //Подставляем значение в слайдер? если он существует. Для синхронизации значений при изменении ползунком/печатью
        }
