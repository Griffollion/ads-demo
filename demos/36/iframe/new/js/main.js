...
//Включение-выключение звука у видео
$(document).on('click','.inpage_volume', function () {
    inpageVideo.volume = 0.4;
    $(".inpage_volume .fa").toggleClass('volume-line');

    inpageVideo.muted = (inpageVideo.muted == false) ? true : false;
});
